...
public class OLD_LayoutBuilderAgent extends Agent{
    ...
    protected void setup() {
        ...
        try {
            ...
            AgentController t1 = containerController.createNewAgent("Mario","agents.PingArgumentsAgent", new Object[]{"Luigi"});
            t1.start();

            AgentController t2 = containerController.createNewAgent("Luigi","agents.PingArgumentsAgent", new Object[]{"Mario","Basta"});
            t2.start();

            AgentController t3 = containerController.createNewAgent("Francesco","agents.PingArgumentsAgent", new Object[]{"Nessuno"});
            t3.start();
